...
This monorepo contains two main packages: `@hahnd/geminid` and `@hahnd/geminid-core`.

## `@hahnd/geminid`

This is the main package for the Geminid CLI. It is responsible for the user interface, command parsing, and all other user-facing functionality.

When this package is published, it is bundled into a single executable file. This bundle includes all of the package's dependencies, including `@hahnd/geminid-core`. This means that whether a user installs the package with `npm install -g @hahnd/geminid` or runs it directly with `npx @hahnd/geminid`, they are using this single, self-contained executable.
