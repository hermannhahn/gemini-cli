# Sandboxing in the Geminid CLI

This document provides a guide to sandboxing in the Geminid CLI, including prerequisites, quickstart, and configuration.

## Prerequisites

Before using sandboxing, you need to install and set up the Geminid CLI:
