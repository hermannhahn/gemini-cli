...
- **[Instruction Tool](./instruction.md) (`save_instruction`):** For saving and recalling information across sessions.
- **[Short-Term Memory (STM) Tools](./memory.md):** For managing short-term conversational memory.
