...
This document describes the `save_memory` tool for the Geminid CLI.

## Description

Use `save_memory` to save and recall information across your Geminid CLI sessions. With `save_memory`, you can direct the CLI to remember key details across sessions, providing personalized and directed assistance.
...
## How to use `save_memory` with the Geminid CLI
