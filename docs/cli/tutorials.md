...
This page contains tutorials for interacting with Geminid CLI.
...
Geminid CLI uses this value in the `mcpServers` configuration that you defined in the `settings.json` file.

#### Launch Geminid CLI and verify the connection

When you launch Geminid CLI, it automatically reads your configuration and launches the GitHub MCP server in the background. You can then use natural language prompts to ask Geminid CLI to perform GitHub actions. For example:
